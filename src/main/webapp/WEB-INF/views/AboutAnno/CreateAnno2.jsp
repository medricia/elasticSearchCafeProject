...
<div id="annoHR"></div>
<div id="AnnoTable">
	<form action="AnnoInsert.cafe" name="boardform" method="post" enctype="multipart/form-data">
		<table>
		<tbody>
		
  <tr>
    <td><input class="borderBottom borderSubject" type="text" name="ANNO_TITLE" placeholder="제목" style="width:1100px;height:40px; font-size:30px; padding-left:10px; margin-top: 10px; font-family: 'Pretendard-Regular';"></td>
  </tr>
  <tr style="padding-top:20px;">
		  <td class="tg-0pky">
				<textarea name="ANNO_CONTEXT" class="boardContentUpdate"></textarea>			    
		    </td>	   
	  </tr>
	    <tr>
	    <td class="tg-0pky" >
